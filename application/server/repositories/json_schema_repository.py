from application.server.repositories.interface_json_schema_repository import InterfaceJSONSchemaRepository
from application.server.models.json_schema import JSONSchema


class JSONSchemaRepository(InterfaceJSONSchemaRepository):
    ...
    def get_last_element(self):
        # Виконання SQL-запиту для отримання останнього елемента
        self.cursor.execute("SELECT * FROM json_schemas ORDER BY json_id DESC LIMIT 1")
